...
namespace BitFab.KW1281Test.Cluster
{
    internal class VdoCluster : ICluster
    {
        ...
        public static int VdoMileageHexToDecimal(string input)
        {
            ...
            // Multiply the sum by 2, since odometer values are stored as half the actual value plus 1
            return sum * 2 +1;
        }
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public static string VdoMileageDecimalToHex(int input)
        {
