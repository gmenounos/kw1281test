...
The tool is written in C#, targetting .NET 5.0 and runs under Windows 10 (most serial ports) and macOS (with an FTDI serial port and D2xx drivers). It may also run under
